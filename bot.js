...
${prefix}help1 ⇏ اوامر عامة

${prefix}help2 ⇏ اوامر ادارة السيرفر
			 
${prefix}help3 ⇏ اوامر الالعاب

${prefix}help4 ⇏ اوامر الموسيقى
...
❖+link ~ يعرض لك روابط الانفايتات حكك في السيرفر 
❖+cal ~ اله حاسبة
...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '257147010488991744') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
